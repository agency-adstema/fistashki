...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Internal notes about the customer' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Whether customer account is active', default: true }),
    (0, class_validator_1.IsOptional)(),
