...
var RealtimeCallGateway_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.RealtimeCallGateway = void 0;
...
const WS = require('ws');
let RealtimeCallGateway = RealtimeCallGateway_1 = class RealtimeCallGateway {
    prisma;
    server;
    logger = new common_1.Logger(RealtimeCallGateway_1.name);
    sessions = new Map();
    constructor(prisma) {
        this.prisma = prisma;
    }
    ...
    async handleStartCall(client, data) {
        try {
    ...
    async handleAudioData(client, data) {
    ...
    async connectToOpenAIRealtime(sessionId, session) {
...
ODMAH počni: "Dobar dan, da li govorim sa ${ime}?"`;
    ...
    async saveCallRecording(session) {
        try {
...
exports.RealtimeCallGateway = RealtimeCallGateway;
__decorate([
    (0, websockets_1.WebSocketServer)(),
    __metadata("design:type", Object)
], RealtimeCallGateway.prototype, "server", void 0);
exports.RealtimeCallGateway = RealtimeCallGateway = RealtimeCallGateway_1 = __decorate([
    (0, websockets_1.WebSocketGateway)({ path: '/ws/calls' }),
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], RealtimeCallGateway);
//# sourceMappingURL=realtime-call.gateway.js.map