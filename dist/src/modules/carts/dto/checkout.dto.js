...
exports.CheckoutDto = exports.GuestInfoDto = void 0;
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Existing customer ID. Takes precedence over guest info.' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CheckoutDto.prototype, "customerId", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ type: GuestInfoDto, description: 'Guest customer info. Used if no customerId.' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.ValidateNested)(),
    (0, class_transformer_1.Type)(() => GuestInfoDto),
    __metadata("design:type", GuestInfoDto)
], CheckoutDto.prototype, "guest", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Existing customer address ID for shipping' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
